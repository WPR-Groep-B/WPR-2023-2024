...
function bedrijfRegistreer() {
    return (
        <div className={styles.body}>
            <div className={styles.container}>
            <h1>Bedrijf registeer pagina</h1>
            <form className={styles.form}>
                ...
                <div>
                    ...
                    <input type="text" id="Bedrijf" name="Bedrijf" placeholder="voor welk bedrijf" required />
                </div>
...
export default bedrijfRegistreer;